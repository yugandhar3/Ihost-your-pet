...
const sendMail = async (email,firstName,RequestingDates,RequestedPetType,RequestedNoOfPetToHost,hostName) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      html:`Thank you <b>${firstName}</b> for requesting  <b>${hostName}</b> to host your pet Tommy <br/><b>Requesting date :</b> ${RequestingDates} <br/><b>Pet Type to Host  :</b>${RequestedPetType} <br/><b>No. of pets to Host :</b>${RequestedNoOfPetToHost}`,
